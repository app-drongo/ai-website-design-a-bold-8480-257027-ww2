...
export default function Cta() {
  const stats = [
    { value: "200+", label: "Brands Launched", icon: Users },
    { value: "98%", label: "Client Satisfaction", icon: Award },
    { value: "3x", label: "Average ROI Boost", icon: Zap },
    { value: "24hr", label: "Response Time", icon: Sparkles }
  ]
          ...
          <CardContent className="relative p-12 lg:p-16">
            <div className="text-center max-w-4xl mx-auto">
              ...
              <div className="inline-flex items-center px-4 py-2 bg-primary/10 border border-primary/20 rounded-full text-sm font-medium text-primary mb-8">
                ...
                Launch Special - 30% Off First Project
              </div>
              ...
              <p className="text-lg sm:text-xl text-muted-foreground max-w-2xl mx-auto mb-12 leading-relaxed">
                Join the ranks of bold brands that chose Neon Creative Studio. 
                Let's create something extraordinary that drives real business results.
              </p>
          ...
          <div className="grid grid-cols-1 md:grid-cols-3 gap-8 max-w-4xl mx-auto">
            <div className="space-y-2">
              ...
              <p className="text-sm text-muted-foreground">
                No commitment strategy session to explore your vision
              </p>
            </div>
            ...
            <div className="space-y-2">
              ...
              <h3 className="font-semibold">Award-Winning Design</h3>
              <p className="text-sm text-muted-foreground">
                Creative excellence recognized by industry leaders
              </p>
            </div>
            ...
            <div className="space-y-2">
              ...
              <p className="text-sm text-muted-foreground">
                Launch your new brand in weeks, not months
              </p>
            </div>
          </div>
        </div>
